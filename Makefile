...
CFLAGS+= -DOPENCV
LDFLAGS+= -L/usr/local/opencv/lib`pkg-config --libs opencv` 
...
EXECOBJA=captcha.o lsd.o super.o art.o tag.o cifar.o go.o rnn.o segmenter.o regressor.o coco.o yolo.o detector.o nightmare.o darknet.o
